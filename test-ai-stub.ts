 ...
 * Run: ANTHROPIC_API_KEY=sk-ant-... npx tsx test-ai-stub.ts
 */
import Anthropic from "@anthropic-ai/sdk";
import { validateGraph } from "./src/lib/strategy/validator";
import { SYSTEM_PROMPT } from "./src/lib/ai/strategy-prompt";
...
const PROMPTS = [
  ...
  "Buy when volume spikes — volume > 1000 — and RSI is below 60. Close after RSI hits 80.",
];
